...
var init = () => {
    ...
    piAccuracy.getDescription = (_) => Utils.getMath("π Digits: " + (piAccuracy.level + 1));
    piAccuracy.getInfo = (amount) => Utils.getMathTo("Correct Digits: " + (piAccuracy.level + 1), "Correct Digits: " + (piAccuracy.level + amount + 1));
    ...
    achievement2 = theory.createSecretAchievement(1, "Approximator", "Approximate the first 10 digits of pi.", "You're actually into approximating numbers, are you?", () => piAccuracy.level >= 10);
